...
let names = runners.forEach((runner) => {
...
let upperCaseName = runners.map((first_name) => {
  return first_name{string.toUpperCase()}
})
...
let runnersLargeSizeShirt = runners.filter((shirt_size) => {
